...
pimcore.registerNS("pimcore.object.importcolumn.operator.fieldsetter");

pimcore.object.importcolumn.operator.fieldsetter = Class.create(pimcore.object.gridcolumn.Abstract, {
    type: "operator",
    class: "FieldSetter",
    iconCls: "icon_sintra_color",
    defaultText: "Field Setter",
    ...
    getConfigDialog: function (node) {
        ...
        this.fieldNameField = new Ext.form.TextField({
            fieldLabel: t('fieldname'),
            width: 400,
            value: this.node.data.configAttributes.fieldName
        });
        ...
        this.configPanel = new Ext.Panel({
            ...
            items: [this.textField, this.phpClassField, this.fieldNameField, this.additionalDataField],
            buttons: [{
                text: t("apply"),
    ...
    commitData: function () {
        ...
        this.node.data.configAttributes.fieldName = this.fieldNameField.getValue();
